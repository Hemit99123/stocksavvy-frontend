        ...
        <div className="bg-[#121826] text-white flex justify-center items-center gap-10 py-32">
            <div>
                <div className="grid grid-cols-2 gap-6 max-w-2xl">
                    <div className="bg-yellow-400 rounded-lg p-6 text-black transform transition-all duration-500" style={{ transform: 'translateY(-15px)' }}>
                    ...
                    <div className="bg-purple-500 rounded-lg p-6 text-white transform transition-all duration-500" style={{ transform: 'translateY(15px)' }}>
                    ...
                    <div className="bg-green-400 rounded-lg p-6 text-black transform transition-all duration-500" style={{ transform: 'translateY(15px)' }}>
